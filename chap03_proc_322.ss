...
;build-in operation, such as difference, from a procedure from a
;procdeure call. Modify the concrete syntax so that the user of
;this language need not know which operations are build-in and
;which are defined procedures. This exercise may range from very
